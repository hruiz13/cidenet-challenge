...
import { addUser, checkDni } from '../../actions/formActions';
...
export const FormScreen = () => {
    ...
    useEffect(() => {
        form.setFieldsValue({ date: moment().format('DD/MM/YYYY HH:mm:ss') })
    ...
    return (
        <>
            <Form {...layout} form={form} name="control-hooks" onFinish={onFinish}>
                ...
                <Form.Item name="date" label="Fecha y hora de registro:">
                    <Input disabled />
                </Form.Item>
